...
<task type="auto">
  ...
  2. Implement calculate_daily_composite(subscores: dict, events: list) from section 7.3:
  ...
  Use exact weights and formulas from design doc sections 7.2 and 7.3.
  </action>
  <verify>
...
- [ ] Daily composite uses commodity trader weights
- [ ] API endpoint returns risk summary
- [ ] All weights and thresholds match design doc
</verification>
...
- Category sub-scores and daily composite calculation working
- API endpoint returns risk summary
